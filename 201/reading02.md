...
* Can be organized into _"code blocks"_ AKA curly braces

**Comments** - Not processed by interpreter. You can/should explain what your code does.

    - single line comment: use // on the line you don't want processed
    - multi line comment: use /* and */ at the end
...
**Expression** - evaluates into a single value  
    *Expressions that only assigns a value to a variable
        - EX: let color = beige
...
* String operator - operator that combines strings
    - EX: greeting = 'hey' + 'you';

**Concatenation** - two or more strings joined together to make one new string. Use + to join. You cannot perform addition operations on strings

---
# Chapter 4 Decisions and Loops (p145-162)

**Conditional statement**: If *blank* is met, then code executes the statements. _Else_ code does something different.
...
**Comparison Operators**: Evaluate a situation by comparing one value in the script to what you think it might be. Results in a Boolean (true or false)

- comparison operators - page 150/151

Conditions take two operands (comparables) and a comparison operator.
Operands can be expressions.

- EX: `((1 + 2) > (1 + 1))`

**Logical Operators**: used to compare the results of more than one comparison operator.
...
- Inverts a Boolean value. (makes a true expression false, vice versa)

**If Statements** - checks a condition in the code block and executes them if they are true.
